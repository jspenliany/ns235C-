...
//for app-------------------
	...
	int8_t  vehicle_fresh_LIST_[VEHICULAR_AMOUNT]; //for common wired node recording the fresh degree of info since the last recv---------range 0~127.-128~-1
	int	support_tavr_app;//------------

	double  comm_send_interval;
	int		current_veh_num;
