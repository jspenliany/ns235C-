...
#define     MOVE_DOWN			0x03
#define		MOVE_RIGHT			0x01

#define TAVR_JITTER		(Random::uniform()*1.7)
...
/*	inline int16_t& vehicle_direction() {
...
//	int16_t		vehicle_direction_list[VEHICULAR_AMOUNT]; //----save storage
...
/*
	inline int16_t* vehicle_directionlist() {
