...
#define		NEWG_DECOUPLE_UPTIME	524287//2^20-1
#define		NEWG_COUPLE_VID			19//BITS
#define		NEWG_DECOUPLE_VID		2146959360// 2^32-1 - 2^20-1

#define		NEWG_DECOUPLE_DIRT		65536//2^17-1
#define		NEWG_SCALE_DIRT			100;
#define		NEWG_SCALE_MDIRT		128;
#define		NEWG_COUPLE_VSPEED		16//BITS
#define		NEWG_DECOUPLE_VSPEED	2147418112// 2^32-1 - 2^17-1
#define		NEWG_SCALE_SPEED		100;

#define		NEWG_DECOUPLE_AXIS		1048575// 2^21-1
