...
#define		VEHICULAR_AMOUNT	1000					//how many vehicular in the network
...
//==============the above macros are old discards ========070215

#define		NEWL_VEHI_NUM		300
#define		NEWG_VEHI_NUM		2048
#define		NEWG_ROW_MAX		32
#define		NEWG_COL_MAX		32
#define		NEWG_BASE_NUM		NEWG_ROW_MAX*NEWG_COL_MAX

#define		NEWG_DECOUPLE_UPTIME	1048575//2^20-1
#define		NEWG_COUPLE_VID			19//BITS
#define		NEWG_DECOUPLE_VID		4293918720// 2^32-1 - 2^20-1

#define		NEWG_DECOUPLE_DIRT		131071//2^17-1
#define		NEWG_SCALE_DIRT			100;
#define		NEWG_SCALE_MDIRT		128;
#define		NEWG_COUPLE_VSPEED		16//BITS
#define		NEWG_DECOUPLE_VSPEED	4294836224// 2^32-1 - 2^17-1
#define		NEWG_SCALE_SPEED		100;

#define		NEWG_DECOUPLE_AXIS		2097151// 2^21-1
#define		NEWG_SCALE_AXIS			100;

#define		NEWG_SHOTRPATH_SIZE		NEWG_ROW_MAX+NEWG_COL_MAX+NEWG_COL_MAX

#define		NEW_DIRECTION_UP		8//1000
#define		NEW_DIRECTION_DOWN		9//1001
#define		NEW_DIRECTION_LEFT		12//1100
#define		NEW_DIRECTION_RIGHT		14//1110

#define		NEW_ORIENT_UP			8
#define		NEW_ORIENT_DOWN			9
#define		NEW_ORIENT_LEFT			12
#define		NEW_ORIENT_RIGHT		14

#define		NEW_LG_LINKS_MAX		10
