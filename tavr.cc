...
TAVRagent::new_Supdate_selfInfo(){
	...
	fprintf(stdout,"\n-----check valid--xy=%8.4f,%8.4f delta=%4.2f,%4.2f bidcpn=%4d,%4d,%4d",S_vehicle_position_x_,S_vehicle_position_y_,
											delta_x,delta_y,S_currentBID,S_loc_BID_previous,S_loc_BID_toward);
}
/**
...
/*			S_loc_BID_previous = S_currentBID;
	...
	fprintf(stdout,"\nTAVRagent::new_Supdate_JuncInfo finish vehi-%d bid=%d %d %d U%d D%d L%d R%d",nodeid,S_currentBID,Stmp_loc_BID_previous,Stmp_loc_BID_toward,tmp_UP,tmp_DOWN,tmp_LEFT,tmp_RIGHT);
}
