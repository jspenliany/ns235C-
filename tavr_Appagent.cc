...
static class TAVRAppAgentClass : public TclClass {
 public:
	TAVRAppAgentClass() : TclClass("Agent/TAVRAppAgent") {}
...
TAVRAppAgent::TAVRAppAgent():Agent(PT_TAVRAPP),running_(0),seqno_(0){

}

TAVRAppAgent::TAVRAppAgent(packet_t type):Agent(type),running_(0),seqno_(0){
